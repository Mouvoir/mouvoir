...
export const TEMPLATE_STICKERS: TemplateSticker[] = [
  ...
  { folder: "lighting_you", slug: "lighting-you", title: "Lighting You", screen: 1, left: 22, top: 58, width: 30 },
  { folder: "shade_&_shape", slug: "shade-and-shape", title: "Shade & Shape", screen: 1, left: 54, top: 60, width: 26 },
  // --- Screen 2 ---
